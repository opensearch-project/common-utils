...
package org.opensearch.commons.ppl.serde;
...
public class SerializeUtils {
    ...
    private static class DataSourceTypeDeserializer implements JsonDeserializer<DataSourceType> {
        @Override
        public DataSourceType deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext)
