...
public enum Format {
    ...
    public static Optional<Format> of(String formatName) {
        String format = Strings.isNullOrEmpty(formatName) ? "jdbc" : formatName.toLowerCase(Locale.ROOT);
    ...
    public static Optional<Format> ofExplain(String formatName) {
        String format = Strings.isNullOrEmpty(formatName) ? "standard" : formatName.toLowerCase(Locale.ROOT);
