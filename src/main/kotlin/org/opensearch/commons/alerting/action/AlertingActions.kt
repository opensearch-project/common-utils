...
object AlertingActions {
    ...
    const val EVENT_LISTENER_ACTION_NAME = "cluster:admin/opensearch/alerting/event/listener"
    ...
    @JvmField
    val EVENT_LISTENER_ACTION_TYPE =
        ActionType(EVENT_LISTENER_ACTION_NAME, ::EventListenerResponse)
}
