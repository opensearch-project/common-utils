...
data class MonitorMetadata(
    ...
    companion object {
        ...
        fun parse(
            ...
            while (xcp.nextToken() != XContentParser.Token.END_OBJECT) {
                ...
                when (fieldName) {
                    ...
                    LAST_RUN_CONTEXT_FIELD -> {
                        lastRunContext = xcp.map()
                    }
        ...
        @JvmStatic
        @Throws(IOException::class)
        fun readFrom(sin: StreamInput): MonitorMetadata = MonitorMetadata(sin)
        ...
        fun getId(
            ...
            return if (workflowMetadataId.isNullOrEmpty()) {
                "${monitor.id}-metadata"
            } else {
                "$workflowMetadataId-${monitor.id}-metadata"
            }
        }
    }
}
...
data class ActionExecutionTime(
    ...
    companion object {
        ...
        @JvmStatic
        @Throws(IOException::class)
        fun readFrom(sin: StreamInput): ActionExecutionTime = ActionExecutionTime(sin)
    }
}
