    ...
    fun `test alertError obfuscates IP addresses in message`() {
        val message =
            "AlertingException[[5f32db4e2a4fa94f6778cb895dae7a24][10.212.77.91:9300][indices:admin/create]]; " +
                "nested: Exception[org.opensearch.transport.RemoteTransportException: " +
                "[5f32db4e2a4fa94f6778cb895dae7a24][10.212.77.91:9300][indices:admin/create]];; " +
                "java.lang.Exception: org.opensearch.transport.RemoteTransportException: " +
                "[5f32db4e2a4fa94f6778cb895dae7a24][10.212.77.91:9300][indices:admin/create]"
